...
# 1. Commits ahead of main (unique commits on this branch)
...
| Category | Commits Ahead | Remote Exists | Description |
|----------|--------------|---------------|-------------|
...
- **Merged / New/Empty:** Delete with `git branch -d <branch-name>`
