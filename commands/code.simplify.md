...
Use the `code-simplifier` "skill" to **ruthlessly and aggressively simplify** code. Be EXTREMELY bold in refactoring - the goal is radical simplification, not incremental improvements.
