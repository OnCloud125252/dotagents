...
function brandMarkup() {
  // Branding removed for standalone use: no external logo fetch
  // (prevents any request to primeradiant.com) and no upstream
  // attribution link. The frame template's <!-- BRANDING --> slot
  // stays empty.
  return '';
}
